namespace Klinik.Common
{
    public static class Constants
    {
        ...
        {
            public const string LOGIN_TO_SYSTEM = "Login To System";
            public const string ADD_NEW_ORG = "Add New Organization";
            public const string ADD_NEW_CLINIC = "Add New Clinic";
            public const string ADD_NEW_EMPLOYEE = "Add New Employee";
            public const string ADD_NEW_USER = "Add New User";
            public const string ADD_NEW_ROLE = "Add New Role";
            public const string ADD_NEW_PRIVILEGE = "Add New Privilege";
            ...
            public const string ADD_DELIVERY_ORDER_PUSAT = "Add New Delivery order pusat";
            ...
            public const string ADD_PURCHASE_ORDER_PUSAT_DETAIL = "Add New Purchase order pusat detail";
            public const string EDIT_PURCHASE_ORDER_PUSAT = "Edit Form Purchase order pusat";
            public const string ADD_PURCHASE_ORDER_PUSAT = "Add New Purchase order pusat";
            public const string EDIT_PURCHASE_REQUEST_DETAIL = "Edit Form Purchase request detail";
        ...
        {
            public const string KlinikDBConnString = "KlinikDB";
