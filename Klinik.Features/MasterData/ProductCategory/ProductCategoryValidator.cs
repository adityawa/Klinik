...
{
    public class ProductCategoryValidator : BaseFeatures
    {
        private const string ADD_PRIVILEGE_NAME = "ADD_M_PRODUCT_CATEGORY";
        private const string EDIT_PRIVILEGE_NAME = "EDIT_M_PRODUCT_CATEGORY";
        private const string DELETE_PRIVILEGE_NAME = "DELETE_M_PRODUCT_CATEGORY";
