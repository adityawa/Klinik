...
{
    public class LabItemValidator : BaseFeatures
    {
        private const string ADD_PRIVILEGE_NAME = "ADD_M_LAB_ITEM";
        private const string EDIT_PRIVILEGE_NAME = "EDIT_M_LAB_ITEM";
        private const string DELETE_PRIVILEGE_NAME = "DELETE_M_LAB_ITEM";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="unitOfWork"></param>
        public LabItemValidator(IUnitOfWork unitOfWork)
        {
