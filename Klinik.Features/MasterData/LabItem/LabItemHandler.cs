    ...
    public class LabItemHandler : BaseFeatures
    {
        ...
        public LabItemResponse CreateOrEdit(LabItemRequest request)
        {
            ...
            try
            {
                ...
                {
                    var labItemEntity = Mapper.Map<LabItemModel, LabItem>(request.Data);
        ...
        public LabItemResponse GetDetail(LabItemRequest request)
        {
            ...
            {
                response.Entity = Mapper.Map<LabItem, LabItemModel>(qry.FirstOrDefault());
            }
        ...
        public LabItemResponse GetListData(LabItemRequest request, Expression<Func<LabItem, bool>> searchCriteria = null)
        {
            ...
            {
                var prData = Mapper.Map<LabItem, LabItemModel>(item);
