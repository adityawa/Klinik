...
namespace Klinik.Features
{
    public class VendorHandler  : BaseFeatures, IBaseFeatures<VendorResponse, VendorRequest>
    {
        ...
        public VendorResponse CreateOrEdit(VendorRequest request)
        {
            ...
            try
            {
                if (request.Data.Id > 0)
                {
                    ...
                    if (qry != null)
                    {
                        var _oldentity = Mapper.Map<Vendor, VendorModel>(qry);
                ...
                {
                    var vendorEntity = Mapper.Map<VendorModel, Vendor>(request.Data);


                   vendorEntity.CreatedBy = request.Data.Account.UserCode;
        ...
        public VendorResponse GetDetail(VendorRequest request)
        {
            ...
            {
                response.Entity = Mapper.Map<Vendor, VendorModel>(qry.FirstOrDefault());
        ...
        public VendorResponse GetListData(VendorRequest request)
        {
            ...
            {
                var prData = Mapper.Map<Vendor, VendorModel>(item);
