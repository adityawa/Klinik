...
namespace Klinik.Features
{
    public class PurchaseOrderPusatValidator : BaseFeatures
    {
        ...
        private void ValidateForValidasi(PurchaseOrderPusatRequest request, out PurchaseOrderPusatResponse response)
        {
            response = new PurchaseOrderPusatResponse();
            ...
            if (response.Status)
            {
                response = new PurchaseOrderPusatHandler(_unitOfWork).ValidasiData(request);
            }
        }
    }
}
